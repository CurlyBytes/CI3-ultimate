...
Some node class names have a trailing `_`. This is used whenever the class name
...
There is not much more to it than converting the namespaced name to string with
`_` as separator.
